...
Formulas are pre-written Salt States, provided by the Salt community. There are plenty of forumlas available unde the [SaltStack Formulas GitHub organization](https://github.com/saltstack-formulas). Their installation is easy, well explained in detail here: [https://docs.saltstack.com/en/latest/topics/development/conventions/formulas.html#installation](https://docs.saltstack.com/en/latest/topics/development/conventions/formulas.html#installation). Basically all you need is structure your pillar as specified in the formula; each formula has also an ``pillar.example`` file to help with a structure example for the pillar.
